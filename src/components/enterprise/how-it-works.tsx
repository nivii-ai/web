    ...
    >
      <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[minmax(0,24rem)_minmax(0,1fr)] lg:gap-24">
        <div className="lg:sticky lg:top-32 lg:self-start">
          ...
          <Reveal order={1} className="mt-10 flex flex-col gap-3">
            <p className="text-body-s text-brand-green">{t("phasePilot")}</p>
            <p className="text-body-s text-panel-ink/60">
              {t("phaseProduction")}
            </p>
          </Reveal>
        </div>
        ...
        <div className="max-w-3xl">
          ...
          >
            ...
            <p className="mt-3 text-body-s text-panel-ink/60">{t("roiBody")}</p>
          </Reveal>
