...
export async function Product() {
  ...
  return (
    <section id="product" className="py-12 scroll-m-28">
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-sm md:max-w-2xl lg:max-w-full mx-auto">
